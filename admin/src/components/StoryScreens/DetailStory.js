...
const DetailStory = () => {
  ...
  const getImageUrl = (image, folder) => {
    if (!image) return "/default-user.png"; // fallback
    return image.startsWith("http") ? image : `/${folder}/${image}`;
  };
              ...
              <div className="fixed-story-options">
                ...
                <ul>
                  ...
                  <li className="BsThreeDots_opt">
                    <i onClick={() => setShowThreeDotsMenu(!showThreeDotsMenu)}>
                      <BsThreeDots />
                    </i>
                    ...
                    {showThreeDotsMenu &&
                      activeUser &&
                      story.author &&
                      String(story.author._id) === String(activeUser._id) && (
                        <div className="top_story_transactions">
                          <Link
                            className="editStoryLink"
                            to={`/story/${story.slug}/edit`}
