...
import AdminChatBotSubmissions from './components/ChatsubmissionScreens/AdminChatBotSubmissions';
import ChatSection from './components/ChatsubmissionScreens/ChatSection';
import CareerManagement from './components/CareerScreens/AdminCareerPage';
                        ...
                        <Routes>
                              <Route path="/" element={<LayoutsWithHeader />}>
                                    ...
                                    <Route exact path='/readList' element={<PrivateRoute />}>
                                     ...
                                     <Route exact path='/chat-section' element={<PrivateRoute />}>
  <Route index element={<ChatSection/>} />
</Route>
                                      <Route exact path="/career" element={<CareerManagement/>} />
